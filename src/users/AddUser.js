...
export default function AddUser() {
  ...
  return (
    <div className='container'>
        <div className="row">
            <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shad">
                ...
                <div className="mb-3">
                    ...
                    <input type={"email"} className="form-control" placeholder='Enter Your Email Address' name="email" value={email} onChange={(e)=>onInputChange(e)} required/>
                </div>
